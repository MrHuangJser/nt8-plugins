...
{
    /// <summary>
    /// Fifty Percent Drawing Tool - 50%划线工具
    /// Displays a single horizontal line at 50% level between two anchors
    /// </summary>
    public class FiftyPercent : DrawingTool
    {
        #region Variables
        ...
        [Display(Name = "Line Color", Description = "Color of the level line", Order = 3, GroupName = "Parameters")]
        ...
        [Display(Name = "Line Width", Description = "Width of the level line", Order = 4, GroupName = "Parameters")]
        [Range(1, 10)]
        public int LineWidth { get; set; }

        [Display(Name = "Label Position", Description = "Display label on left or right side", Order = 5, GroupName = "Parameters")]
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = @"Fifty Percent - 50%划线工具";
                Name = "FiftyPercent";
        ...
        public override void OnCalculateMinMax()
        {
            ...
            MinValue = Math.Min(MinValue, midPrice);
            MaxValue = Math.Max(MaxValue, midPrice);
        }
        ...
        public override void OnRender(ChartControl chartControl, ChartScale chartScale)
        {
            ...
            float y = chartScale.GetYByValue(midPrice);
